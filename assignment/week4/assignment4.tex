...
\begin{enumerate}[leftmargin=1.5em]
    ...
    \item S. Mera and Y. Cao,
    ``Model Based Testing -- An Introduction to Model-Based Testing
    and Spec Explorer,''
    \textit{MSDN Magazine}, December 2013.
    Available at:
    \url{https://learn.microsoft.com/en-us/archive/msdn-magazine/2013/december/model-based-testing-an-introduction-to-model-based-testing-and-spec-explorer}

    \item F. Toledo,
    ``Model-Based Testing Using State Machines,''
    \textit{Abstracta}, March 25, 2020.
    Available at:
    \url{https://abstracta.us/blog/software-testing/model-based-testing-using-state-machines/}

\end{enumerate}

\subsection*{AI Assistance Disclosure}

AI assistance was used during the preparation of this document to help
organise, format, and review the requirements validation report,
including LaTeX formatting, document layout, tables, and TikZ diagrams.
AI was also used as a review aid during the Model-Based Validation
process, as documented in Sections~A.2 and~B.2. The behavioural model,
validation findings, requirement refinements, and final decisions were
reviewed and determined by the group. AI suggestions were not accepted
automatically; they were considered against the project requirements
and either accepted, modified, deferred, or rejected based on our own
reasoning.
